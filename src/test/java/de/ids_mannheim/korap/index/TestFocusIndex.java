...
public class TestFocusIndex {
    ...
    public void testFocusInNextBug2 () throws QueryException, IOException {
        ...
        fd.addTV("base", "cabbcca",
            "[(0-1)s:c|<>:base/s:t$<b>64<i>0<i>7<i>7<b>0|_0$<i>0<i>1]"+
            "[(1-2)s:a|a:c|_1$<i>1<i>2]"+
            "[(2-3)s:b|_2$<i>2<i>3]"+
            "[(3-4)s:b|_3$<i>3<i>4]"+
            "[(4-5)s:c|_4$<i>4<i>5]"+
            "[(5-6)s:c|a:c|_5$<i>5<i>6]"+
            "[(6-7)s:a|a:d|_6$<i>6<i>7]"
            );
        ki.addDoc(fd);
        ...
        fd.addTV("base", "bea",
            "[(0-1)s:b|<>:base/s:t$<b>64<i>0<i>3<i>3<b>0|a:a|_0$<i>0<i>1]"+
            "[(1-2)s:e|a:d|_1$<i>1<i>2]"+
            "[(2-3)s:a|a:e|_2$<i>2<i>3]"
            );
        ki.addDoc(fd);

        fd = new FieldDocument();
        fd.addString("ID", "doc-6");
        fd.addTV("base", "abdcddcb",
            "[(0-1)s:a|<>:base/s:t$<b>64<i>0<i>8<i>8<b>0|a:b|a:d|_0$<i>0<i>1]"+
            "[(1-2)s:b|a:c|_1$<i>1<i>2]"+
            "[(2-3)s:d|a:c|_2$<i>2<i>3]"+
            "[(3-4)s:c|a:e|_3$<i>3<i>4]"+
            "[(4-5)s:d|a:b|_4$<i>4<i>5]"+
            "[(5-6)s:d|_5$<i>5<i>6]"+
            "[(6-7)s:c|a:a|_6$<i>6<i>7]"+
            "[(7-8)s:b|_7$<i>7<i>8]"
            );
        ki.addDoc(fd);
        ki.commit();
        ...
        focus = kq.seq(kq.seg("a:b"),kq.focus(kq.seq(kq.seg("s:a"),kq.seg("s:b"),kq.nr(1, kq.seg("s:c")))));
