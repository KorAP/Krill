...
public class TestMatchIdentifier {
    ...
    public void indexExample1 () throws IOException {
        ...
        Krill ks = new Krill(kq.nr(2,
                kq.seq(kq.seg("s:b")).append(kq.nr(kq.seg("s:a")))));
    ...
    public void indexExample2 () throws IOException, QueryException {
        ...
        assertEquals("match-c1!d1-p7-9(0)8-8(2)7-8", res.at("/matchID")
                .asText());
    ...
    public void snippetBugTest () throws IOException, QueryException {
        KrillIndex ki = new KrillIndex();
        ki.addDoc(
                getClass().getResourceAsStream("/wiki/wpd15-u43-34816.json.gz"),
                true);
        ki.commit();
    ...
    public void snippetBugTest2 () throws IOException, QueryException {
        ...
        Match km = ki.getMatchInfo("match-WDD17/982/72848-p15844-15846",
                "tokens", "lwc", "d", true, true, true);
    ...
    public void snippetBugTest3 () throws IOException, QueryException {
        KrillIndex ki = new KrillIndex();
        ki.addDoc(
                getClass().getResourceAsStream("/wiki/WPD17-H81-63495.json.gz"),
                true);
        ki.commit();
        ...
        km = ki.getMatchInfo("match-WPD17/H81/63495-p88-91", "tokens", "xyz",
                "s", false, false, false);
        km.setContext(new SearchContext(true, (short) 2, true, (short) 2));

        snippet = km.getSnippetHTML();
        assertEquals("<span class=\"context-left\">"
                + "<span class=\"more\"></span>" + "angesehen wurde. "
                + "</span>" + "<span class=\"match\">"
                + "<mark>Der alte Baum</mark>" + "</span>"
                + "<span class=\"context-right\">" + " war eine"
                + "<span class=\"more\"></span>" + "</span>", snippet);
        ...
        assertEquals("<span class=\"context-left\">" + "</span>"
                + "<span class=\"match\">" + "<mark>Der alte Baum</mark>"
                + " war eine Sommerlinde (Tilia platyphyllos) , "
                + "der neue ist eine Winterlinde (Tilia cordata)." + "</span>"
                + "<span class=\"context-right\">" + "</span>", snippet);
        ...
        */
        ...
        km = ki.getMatchInfo("match-WPD17/H81/63495-p88-91", "tokens", null,
                null, false, true, true);
        snippet = km.getSnippetHTML();
        assertEquals("<span class=\"context-left\"></span>"
                + "<span class=\"match\">" + "<mark>"
                + "<span title=\"tt/l:die\">"
                + "<span title=\"tt/p:ART\">Der</span>" + "</span>" + " "
                + "<span title=\"tt/l:alt\">"
                + "<span title=\"tt/p:ADJA\">alte</span>" + "</span>" + " "
                + "<span title=\"tt/l:Baum\">"
                + "<span title=\"tt/p:NN\">Baum</span>" + "</span>" + "</mark>"
                + " " + "<span title=\"tt/l:sein\">"
                + "<span title=\"tt/p:VAFIN\">war</span>" + "</span>" + " "
                + "<span title=\"tt/l:eine\">"
                + "<span title=\"tt/p:ART\">eine</span>" + "</span>" + " "
                + "<span title=\"tt/l:Sommerlinde\">"
                + "<span title=\"tt/l:Sommerlinde\">"
                + "<span title=\"tt/p:NE\">"
                + "<span title=\"tt/p:NN\">Sommerlinde</span>" + "</span>"
                + "</span>" + "</span>" + " ("
                + "<span title=\"tt/p:NE\">Tilia</span>" + " "
                + "<span title=\"tt/p:ADJA\">" + "<span title=\"tt/p:ADJD\">"
                + "<span title=\"tt/p:NE\">" + "<span title=\"tt/p:NN\">"
                + "<span title=\"tt/p:VVFIN\">platyphyllos</span>" + "</span>"
                + "</span>" + "</span>" + "</span>" + ") , "
                + "<span title=\"tt/l:die\">"
                + "<span title=\"tt/p:ART\">der</span>" + "</span>" + " "
                + "<span title=\"tt/l:neu\">"
                + "<span title=\"tt/p:ADJA\">neue</span>" + "</span>" + " "
                + "<span title=\"tt/l:sein\">"
                + "<span title=\"tt/p:VAFIN\">ist</span>" + "</span>" + " "
                + "<span title=\"tt/l:eine\">"
                + "<span title=\"tt/p:ART\">eine</span>" + "</span>" + " "
                + "<span title=\"tt/l:Winterlinde\">"
                + "<span title=\"tt/l:Winterlinde\">"
                + "<span title=\"tt/p:NE\">"
                + "<span title=\"tt/p:NN\">Winterlinde</span>" + "</span>"
                + "</span>" + "</span>" + " ("
                + "<span title=\"tt/p:NE\">Tilia</span>" + " "
                + "<span title=\"tt/p:NE\">cordata</span>" + ")." + "</span>"
                + "<span class=\"context-right\">" + "</span>", snippet);
        km = ki.getMatchInfo("match-WPD17/H81/63495-p88-91", "tokens",
        ...
        snippet = km.getSnippetHTML();
        assertEquals("<span class=\"context-left\"></span>"
                + "<span class=\"match\">" + "<span title=\"dereko/s:s\">"
                + "<mark>Der alte Baum</mark>" + " war eine "
    ...
    public void indexExample6Relations () throws IOException, QueryException {
        ...
        assertEquals("SnippetHTML (1)", "<span class=\"context-left\">"
                ...
                + "</span>" + "<span title=\"x/o:zweitens\">" + "b" + "</span>"
        ...
        assertEquals("SnippetHTML (2)", "<span class=\"context-left\">"
                ...
                + "<span title=\"x/o:erstens\">"
                + "<span xlink:title=\"x/rel:a\" " + "xlink:show=\"none\" "
                + "xlink:href=\"#token-c1!d1-p3\">a</span>" + "</span>"
    ...
    public void indexMultipleSpanStarts () throws IOException, QueryException {
        ...
        km = ki.getMatchInfo("match-c1!d5-p0-4", "tokens", null, null, true,
                false);
        ...
        Krill ks = new Krill(new QueryBuilder("tokens")
                .seg("marmot/m:case:nom").with("marmot/m:degree:pos"));
        Result kr = ks.apply(ki);

        assertEquals(83, kr.getTotalResults());
        assertEquals("match-GOE/AGA/03828-p0-1", kr.getMatch(0).getID());

        km = ki.getMatchInfo("match-GOE/AGA/03828-p0-10", "tokens", "malt",
                null, true, false);
        ...
        assertEquals("SnippetBrackets (with Spans)",
                "[[{malt/d:ATTR>2:Autobiographische} "
                        ...
                        + "({malt/d:APP>2:1}) " + "{malt/d:ADV>5:immer} "
                        + "{#5:{malt/d:ATTR>2:tätiger}}, "
                        + "{#6:{malt/d:PP>13:nach}} "
                        + "{#7:{malt/d:PN>6:innen}} " + "{malt/d:KON>7:und} "
                        + "{malt/d:ADV>11:außen}]] " + "...",
                km.getSnippetBrackets());
    };
    ...
    @Test
    public void indexDependencyAnnotations () throws IOException,
            QueryException {
        KrillIndex ki = new KrillIndex();
        FieldDocument fd = ki.addDoc(2,
                getClass().getResourceAsStream("/goe/Corpus-Doc-0002.json"),
                false);
        ...
        km = ki.getMatchInfo("match-Corpus/Doc/0002-p0-6", "tokens", "malt",
                null, true, false);
    ...
    private FieldDocument createSimpleFieldDoc5 () {
        ...
        fd.addString("corpusID", "c1");
        fd.addString("ID", "d5");
        fd.addTV("tokens", "xyz", "[(0-1)s:x|i:x" + "|<>:x/tag:v$<b>65<i>1"
                + "|<>:x/tag:c$<b>64<i>1<i>0<i>2"
                + "|<>:x/tag:a$<b>64<i>2<i>0<i>3"
                + "|<>:x/tag:b$<b>64<i>2<i>0<i>3" + "|_1$<i>0<i>1]"
                + "[(1-2)s:y|i:y|_2$<i>1<i>2]" + "[(2-3)s:z|i:z|_3$<i>2<i>3]");
        return fd;
    };
    ...
    private FieldDocument createSigleDoc1 () {
        ...
        fd.addInt("UID", 1);
        fd.addTV("tokens", "abcabcabac", "[(0-1)s:a|i:a|_0$<i>0<i>1|-:t$<i>10]"
