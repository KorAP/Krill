...
public final class KrillIndex implements IndexInfo {
    ...
    // Some initializations ...
    {
        ...
        if (prop != null) {
            ...
            this.maxMatchTokens = KrillProperties.maxMatchTokens;
        }
    ...
    */
    public Match getMatchInfo (String idString, String field, boolean info,
        ...
        return getMatchInfo(idString, field, info, foundry, layer, includeSpans,
                ...
                extendToSentence, maxMatchTokens);
    };
        ...
        try {
            ...
            for (LeafReaderContext atomic : this.reader().leaves()) {
                ...
                for (; i < hits; i++) {
                    ...
                    int maxMatchSize = maxMatchTokens;
                    if (ks.getMaxMatchTokens() > 0) {
                        maxMatchSize = ks.getMaxMatchTokens();
                    };
