...
//    private Collection<byte[]> payload;
     ...
     */
    public Match (int maxMatchTokens, PositionsToOffset pto,
                  int localDocID, int startPos, int endPos) {
        this.positionsToOffset = pto;
        this.localDocID = localDocID;
        this.setStartPos(maxMatchTokens, startPos);
        this.setEndPos(maxMatchTokens, endPos);
    };
     ...
     */
    public Match (int maxMatchTokens, String idString, boolean includeHighlights) {
        ...
        if (id.getStartPos() > -1) {
            ...
            this.setStartPos(maxMatchTokens, id.getStartPos());
            this.setEndPos(maxMatchTokens, id.getEndPos());
     ...
     */
    @JsonIgnore
    public void setStartPos (int maxMatchTokens, int pos) {
        this.startPos = pos;
     ...
     */
    @JsonIgnore
    public void setEndPos (int maxMatchTokens, int pos) {
        if (maxMatchTokens > KrillProperties.maxMatchTokens) {
            maxMatchTokens = KrillProperties.maxMatchTokens;
            this.endCutted = true;
        }
