...
//    private Collection<byte[]> payload;
    ...
    public Match (KrillConfiguration config, PositionsToOffset pto,
        ...
        this.setStartPos(config.getMaxMatchTokens(), startPos);
        this.setEndPos(config.getMaxMatchTokens(), endPos);
    };
    ...
    public Match (KrillConfiguration config, String idString, boolean includeHighlights) {
        ...
        if (id.getStartPos() > -1) {
            ...
            this.setStartPos(config.getMaxMatchTokens(), id.getStartPos());
            this.setEndPos(config.getMaxMatchTokens(), id.getEndPos());
